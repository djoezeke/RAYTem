...
◎ A Base Project Setup for RAY/ImGui
```

<p align="center"><h1 align="center">RAYLIB TEMPLATE</h1></p>
<p align="center">
  <em><code>C++ Rendering/Graphics project template with RayLib and Dear ImGUI.
</code></em>
</p>
<p align="center">
  <img src="https://img.shields.io/github/license/djoezeke/RAYTem?style=default&logo=opensourceinitiative&logoColor=white&color=0080ff" alt="license">
  <img src="https://img.shields.io/github/last-commit/djoezeke/RAYTem?style=default&logo=git&logoColor=white&color=0080ff" alt="last-commit">
  <img src="https://img.shields.io/github/languages/top/djoezeke/RAYTem?style=default&color=0080ff" alt="repo-top-language">
  <img src="https://img.shields.io/github/languages/count/djoezeke/RAYTem?style=default&color=0080ff" alt="repo-language-count">
</p>
...
This repository template should allow for a fast and hassle-free kick start of your next RAY project using CMake.
...
A Raylib project template with Dear ImGUI, and Raylib.
This repository is a template OpenGL project configured using CMake.
It supports cross-platform builds, and provides a good starting point to begin Raylib development.
...
<div>
   <table> 
      ...
      <tbody> 
         <tr> 
            <td><a href="https://github.com/libRAY-org/RAY">RAY</a></td> <td>Window/Renderer</td> <td>Cross-platform renderer</td> 
         </tr> 
         <tr> 
...
- **💬 [Join the Discussions](https://github.com/djoezeke/RAYTem/discussions)**: Share your insights, provide feedback, or ask questions.
- **🐛 [Report Issues](https://github.com/djoezeke/RAYTem/issues)**: Submit bugs found or log feature requests for the `RAYTem` project.
- **💡 [Submit Pull Requests](https://github.com/djoezeke/RAYTem/blob/main/CONTRIBUTING.md)**: Review open PRs, and submit your own PRs.
...
2. **Clone Locally**: Clone the forked repository to your local machine using a git client.
   ```sh
   git clone --recursive https://github.com/djoezeke/RAYTem
   ```
...
<br>
<p align="left">
   <a href="https://github.com{/djoezeke/RAYTem/}graphs/contributors">
      <img src="https://contrib.rocks/image?repo=djoezeke/RAYTem">
   </a>
</p>
</details>
...
<!-- <picture>
  <source
    ...
    srcset="
      https://api.star-history.com/svg?repos=RAYTem/djoezeke&type=Date&theme=dark
    "
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="
      https://api.star-history.com/svg?repos=RAYTem/djoezeke&type=Date
    "
  />
  <img
    alt="Star History Chart"
    src="https://api.star-history.com/svg?repos=RAYTem/djoezeke&type=Date"
  />
</picture> -->
